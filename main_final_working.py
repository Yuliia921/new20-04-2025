...
protocol_id = def save_to_db(fio, template, content):
...
async def view_protocol(protocol_id: int, request: Request):
    file_url = f"/static/protocols/{protocol_id}.pdf"
    local_path = f"data/protocols/{protocol_id}.pdf"
