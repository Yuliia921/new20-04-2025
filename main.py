...
Дата рождения: {clean_value(birthdate)}"),
                  ("Жалобы", complaints), ("Анамнез morbi", anamnez_morbi),
                  ("Гинекологический анамнез", gyn_anamnez), ("Менархе", menarche),
                  ("Менструации", menstruation), ("П.М.", last_period), ("Беременности", pregnancies),
                  ("Гинекологические заболевания", gyn_diseases), ("Соматические заболевания", somatic_diseases),
                  ("Объективный статус", objective), ("Молочные железы", breasts), ("Живот", abdomen),
                  ("Диурез", diuresis), ("Стул", stool), ("Наружные половые органы", external_genitals),
                  ("На зеркалах", speculum), ("Выделения", discharge), ("Шейка матки", cervix),
                  ("PV", pv), ("Диагноз", diagnosis), ("Обследование", examination),
...
Возраст: {clean_value(age)}"),
    ...
    for label, value in fields:
        ...
        try:
            pdf.multi_cell(180, 10, text_line or "-")
        except:
